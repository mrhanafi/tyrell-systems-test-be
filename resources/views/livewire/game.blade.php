<div class="p-10 overflow-x-auto w-auto h-screen">
    ...
    <div class='sticky'>
        ...
        <div class='py-3 items-center flex flex-col gap-2'>
            ...
            <div class='flex gap-2'>
                <div>
                    <input type="number" step={1} wire:model='peopleCount' name='people'
                        class='mt-1 block w-full border border-gray-300 rounded-md shadow-sm py-2 px-3 focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm @if($error) text-red-900 focus:ring-red-500 focus:border-red-500 border-red-300 @endif"' />
                </div>
    ...
    <div class='flex flex-col gap-2'>
        ...
        <div>
            ...
            <div class='flex gap-2 py-2 px-3 overflow-y-auto'>
